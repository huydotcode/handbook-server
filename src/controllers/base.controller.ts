...
import { getDecodedTokenFromHeaders } from '../common/utils';
...
export class BaseController {
     ...
     */
    protected getOptionalUserId(req: Request): string | undefined {
        if (req.user?.id) {
            return req.user.id;
        }
     ...
     */
    protected validateRequiredBodyField(body: any, fieldName: string): void {
        if (
            !body ||
